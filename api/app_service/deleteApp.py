...
def delete_app_service(app_id, workspace_id, creds, version, host) -> list:
    ...
    try:
        ...
        print(f"!!! Delete app Request failed (Network/Timeout): {e}")
        return False
    except json.JSONDecodeError:
        if resp.status_code == 200:
             return True
        print("!!! Delete app failed (JSON Decode Error): Response was not valid JSON.")
        return False
