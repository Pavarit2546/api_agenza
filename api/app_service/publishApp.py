...
def publish_app_service(creds, version, host, workspace_id, workflow_id, app_id):
    """
    ...
    data = OrderedDict([
        ...
        #  { 
        #     "IsPublish": True,
        #     "AuthType": "AppCenterAuthTypePublic",           
        #     "CategoryCodeList": [],  
        #     "AuthRangeType": "All"         
        # }),
        ("Top", {})
    ...
    print("Requesting Publish App URL:", url)
    ...
    try:
        ...
        if resp.status_code != 200:
            ...
            print(f"Copy App Failed: {error.get('Message')}")
            return {
                "error": True,
